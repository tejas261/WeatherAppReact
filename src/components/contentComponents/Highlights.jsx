    ...
    <div className="flex flex-col m-10 h-[40rem] rounded-3xl text-3xl bg-[#191919]">
      ...
      <div className="flex flex-row justify-between items-center h-[30rem] border-white border-2 bg-[#000] rounded-3xl m-6 p-5">
        ...
        <div className="w-full text-3xl p-4">
          ...
          <img className="w-16" src="public/assets/sunset.png"/>
            <div>
              <h4>Sunrise</h4>
              <h1>{weatherdata.currentConditions.sunrise.slice(0,5)}</h1>
            </div>
            <img className="w-16" src="public/assets/sunrise.png"/>
            <div>
              <h4>Sunset</h4>
      ...
      <div className="flex justify-between p-3">
        <div className='divs'>
          ...
          <div className="flex p-2">
            <img className="w-16" src="public/assets/humidity.png" alt="" />
        ...
        <div className='divs'>
          <h1>Pressure</h1>
          <div className="flex p-2">
          <img className="w-16" src="public/assets/pressure.png" alt="" />
        ...
        <div className='divs'>
          <h1>Wind Speed</h1>
          <div className="flex p-2">
            <img className="w-16" src="public/assets/wind.png" alt="" />
