      ...
      <div className="flex flex-row justify-between items-center h-[30rem] border-white border-2 bg-[#000] rounded-3xl m-6 p-5">
        <div className="w-full text-3xl p-4">
          ...
          <div className="flex border-white rounded-2xl border-2 p-6 justify-between m-5">
            <img className="w-16" src="public/static/assets/air.png" alt="" />
            <div>
              <h4>CO</h4>
        ...
        <div className="w-full text-3xl p-4">
          ...
          <img className="w-16" src="public/static/assets/sunset.png"/>
            <div>
              <h4>Sunrise</h4>
              <h1>{weatherdata.currentConditions.sunrise.slice(0,5)}</h1>
            </div>
            <img className="w-16" src="public/static/assets/sunrise.png"/>
            <div>
              <h4>Sunset</h4>
      ...
      <div className="flex justify-between p-3">
        <div className='divs'>
          ...
          <div className="flex p-2">
            <img className="w-16" src="public/static/assets/humidity.png" alt="" />
        ...
        <div className='divs'>
          <h1>Pressure</h1>
          <div className="flex p-2">
          <img className="w-16" src="public/static/assets/pressure.png" alt="" />
        ...
        <div className='divs'>
          <h1>Wind Speed</h1>
          <div className="flex p-2">
            <img className="w-16" src="public/static/assets/wind.png" alt="" />
        ...
        <div className='divs'>
          <h1>Feels Like</h1>
          <div className="flex p-2">
            <img className="w-16" src="public/static/assets/temp.png" alt="" />
